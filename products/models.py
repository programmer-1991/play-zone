...
class Game(models.Model):
    ...
    platform = models.ForeignKey(
        Platform, null=True, on_delete=models.SET_NULL)
...
class Product(models.Model):
    ...
    game = models.OneToOneField(
        Game, on_delete=models.SET_NULL, verbose_name="If Product is a Game",
        related_name="product", null=True, blank=True)
    console = models.OneToOneField(
        Console, on_delete=models.SET_NULL,
        verbose_name="If Product is a Console",
        related_name="product", null=True, blank=True)
    sku = models.CharField(
        max_length=254, verbose_name="Stock Keeping Unit (SKU)",
