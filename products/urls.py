...
urlpatterns = [
    ...
    path('edit/console/<int:console_id>/',
         views.edit_console, name="edit_console"),
    path('delete/product/<int:product_id>/',
         views.delete_product, name='delete_product'),
    path('delete/game/<int:game_id>/',
         views.delete_game, name='delete_game'),
    path('delete/console/<int:console_id>/',
         views.delete_console, name='delete_console'),
]
